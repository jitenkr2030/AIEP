...
export default class Reactor<RoomSchema extends import("./presence.ts").RoomSchemaShape = {}> {
     ...
     */
    _appStatusState: import("./clientTypes.ts").AppStatusState & {
     ...
     */
    _setAppStatus(status: "active" | "read-only" | "disabled" | undefined): void;
    subscribeAppStatus(cb: any): () => void;
    ...
    notifyAppStatusSubs(state: any): void;
    ...
    signInAsGuest(params: any): Promise<authAPI.VerifyResponse>;
