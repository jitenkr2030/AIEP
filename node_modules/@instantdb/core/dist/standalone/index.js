function G(n) {
  ...
  for (let s = 0; s < e.length; s++) {
    ...
    t = Math.imul(t ^ i, 2654435761), r = Math.imul(r ^ i, 1597334677);
  }
...
function We(n) {
  ...
  if (n && typeof n == "object") {
    ...
    for (let s = 0; s < e.length; s++) {
      const i = e[s], o = n[i];
      o !== void 0 && (r || (t += ","), t += JSON.stringify(i) + ":" + We(o), r = !1);
    }
    return t + "}";
  }
  return n === void 0 ? "undefined" : typeof n == "bigint" ? `${n}n` : JSON.stringify(n) ?? String(n);
}
function Se(n) {
  if (typeof n == "number")
...
const x = {
  ...
  Replace: "replace",
  Add: "add"
}, In = /* @__PURE__ */ Symbol.for("__MUTATIVE_PROXY_DRAFT__"), _r = /* @__PURE__ */ Symbol("__MUTATIVE_RAW_RETURN_SYMBOL__"), Ve = Symbol.iterator, ee = {
  mutable: "mutable",
  immutable: "immutable"
}, Pt = {};
function $e(n, e) {
...
function I(n) {
  return typeof n != "object" ? null : n?.[In];
}
function xt(n) {
  var e;
  const t = I(n);
...
const vr = Object.prototype.propertyIsEnumerable;
function En(n, e) {
  let t;
  if (Array.isArray(n))
...
function W(n) {
  n.copy || (n.copy = En(n.original, n.options));
}
function Ee(n) {
  if (!ie(n))
    return xt(n);
...
function _e(n, e, t, r, s) {
  ...
  switch (be(n)) {
    case 2:
      ...
      n.set = n.clear = n.delete = Vt;
      break;
    case 3:
      for (const a of n)
        _e(a, a, t, r, s);
      n.add = n.clear = n.delete = Vt;
      break;
    case 1:
      Object.freeze(n);
      let o = 0;
...
function Ar(n, e) {
  ...
  n.finalities.revoke.length > 1 && n.assignedMap.get(e) && t && Mn(de(t, e), n.finalities.handledSet, n.options);
}
function pt(n) {
...
function Dt(n, e, t, r) {
  ...
  s && (s.callbacks || (s.callbacks = []), s.callbacks.push((i, o) => {
    ...
    if (le(de(c, e), t)) {
      let u = s.original;
      s.copy && (u = s.copy), pt(n), yt(n, r, i, o), n.options.enableAutoFreeze && (n.options.updatedValues = (a = n.options.updatedValues) !== null && a !== void 0 ? a : /* @__PURE__ */ new WeakMap(), n.options.updatedValues.set(u, s.original)), De(c, e, u);
    }
...
function Or({ original: n, copy: e, assignedMap: t }, r, s, i, o) {
  t.forEach((a, c) => {
    const u = de(n, c), l = Qe(de(e, c)), f = a ? $e(n, c) ? x.Replace : x.Add : x.Remove;
...
const He = (n, e, t = !1) => {
  ...
  set(n, e) {
    ...
    return (!r.has(n) || !le(r.get(n), e)) && (W(t), ce(t), t.assignedMap.set(n, !0), t.copy.set(n, e), Dt(t, n, e, Re)), this;
  },
  delete(n) {
    if (!this.has(n))
      return !1;
    const e = I(this);
    return W(e), ce(e), e.original.has(n) ? e.assignedMap.set(n, !1) : e.assignedMap.delete(n), e.copy.delete(n), !0;
  },
  clear() {
    const n = I(this);
    if (this.size) {
      W(n), ce(n), n.assignedMap = /* @__PURE__ */ new Map();
  ...
  get(n) {
    ...
    if (r.options.strict && He(s, r.options, i), i || r.finalized || !ie(s, r.options) || s !== r.original.get(n))
      return s;
    const o = Pt.createDraft({
      original: s,
      parentDraft: r,
      key: n,
...
}, Cr = Reflect.ownKeys(bt), Qt = (n, e, { isValuesIterator: t }) => () => {
  var r, s;
  const i = e.next();
  if (i.done)
    return i;
  ...
  if (n.options.strict && He(o, n.options, u), !u && !c && ie(o, n.options) && !n.finalized && n.original.has(o)) {
    const l = Pt.createDraft({
      original: o,
      parentDraft: n,
      key: o,
  ...
  add(n) {
    const e = I(this);
    return this.has(n) || (W(e), ce(e), e.assignedMap.set(n, !0), e.setMap.set(n, n), Dt(e, n, n, Re)), this;
  },
  delete(n) {
    if (!this.has(n))
      return !1;
  ...
  values() {
    ...
    return {
      ...
      next: Qt(n, e, { isValuesIterator: !0 })
    };
  },
  entries() {
    const n = I(this);
...
Set.prototype.difference && Object.assign(Je, {
  intersection(n) {
...
const Er = Reflect.ownKeys(Je), Pn = /* @__PURE__ */ new WeakSet(), jn = {
  get(n, e, t) {
    var r, s;
    ...
    if (n.options.mark) {
      ...
      if (o = n.options.mark(u, ee), o === ee.mutable)
        return n.options.strict && He(u, n.options, !0), u;
    }
    const a = X(n);
    if (a instanceof Map && Cr.includes(e)) {
      if (e === "size")
    ...
    if (a instanceof Set && Er.includes(e)) {
      if (e === "size")
        return Object.getOwnPropertyDescriptor(Je, "size").get.call(n.proxy);
      const u = Je[e];
      if (u)
        return u.bind(n.proxy);
    }
    ...
    const c = a[e];
    if (n.options.strict && He(c, n.options), n.finalized || !ie(c, n.options))
      return c;
    if (c === it(n.original, e)) {
      if (W(n), n.copy[e] = Ut({
  ...
  set(n, e, t) {
    ...
    const o = it(X(n), e), a = I(o);
    return a && le(a.original, t) ? (n.copy[e] = t, n.assignedMap = (r = n.assignedMap) !== null && r !== void 0 ? r : /* @__PURE__ */ new Map(), n.assignedMap.set(e, !1), !0) : (le(t, o) && (t !== void 0 || $e(n.original, e)) || (W(n), ce(n), $e(n.original, e) && le(t, n.original[e]) ? n.assignedMap.delete(e) : n.assignedMap.set(e, !0), n.copy[e] = t, Dt(n, e, t, Re)), !0);
  },
  has(n, e) {
    return e in X(n);
  },
  ...
  deleteProperty(n, e) {
    var t;
    return n.type === 1 ? jn.set.call(this, n, e, void 0, n.proxy) : (it(n.original, e) !== void 0 || e in n.original ? (W(n), ce(n), n.assignedMap.set(e, !1)) : (n.assignedMap = (t = n.assignedMap) !== null && t !== void 0 ? t : /* @__PURE__ */ new Map(), n.assignedMap.delete(e)), n.copy && delete n.copy[e], !0);
  }
};
function Ut(n) {
  ...
  (r || "key" in n) && (a.key = r);
  const { proxy: c, revoke: u } = Proxy.revocable(o === 1 ? Object.assign([], a) : a, jn);
  if (s.revoke.push(u), Pn.add(c), a.proxy = c, t) {
    const l = t;
    l.finalities.draft.push((f, d) => {
      ...
      if (g) {
        let A = g.original;
        g.operated && (A = xt(y)), pt(g), yt(g, Re, f, d), l.options.enableAutoFreeze && (l.options.updatedValues = (h = l.options.updatedValues) !== null && h !== void 0 ? h : /* @__PURE__ */ new WeakMap(), l.options.updatedValues.set(A, g.original)), De(b, r, A);
      }
...
function Mr(n, e, t, r, s) {
  ...
  return o && ht(o), s && _e(u, u, o?.options.updatedValues), [
    u,
...
function Pr(n, e) {
  ...
  let s, i;
  e.enablePatches && (s = [], i = []);
  const a = ((t = e.mark) === null || t === void 0 ? void 0 : t.call(e, n, ee)) === ee.mutable || !ie(n, e) ? n : Ut({
    original: n,
    parentDraft: null,
    finalities: r,
    options: e
...
function $n(n) {
  ...
  let s;
  function i() {
    s = r === 2 ? $t(n) ? new Map(n) : new (Object.getPrototypeOf(n)).constructor(n) : r === 3 ? Array.from(t.setMap.values()) : En(n, t?.options);
  }
  if (t) {
    t.finalized = !0;
    try {
  ...
  if (Rt(s, (o, a) => {
    ...
    return jt(o) ? new Set(s) : new (Object.getPrototypeOf(o)).constructor(s);
  }
  return s;
}
function Bt(n) {
...
const jr = (n) => function e(t, r, s) {
  var i, o, a;
  if (typeof t == "function" && typeof r != "function")
    return function(k, ...N) {
      return e(k, (C) => t.call(this, C, ...N), r);
    };
  const c = t, u = r;
  let l = s;
  ...
  const f = ye(c) ? Bt(c) : c, d = Array.isArray(l.mark) ? ((k, N) => {
  ...
  const R = (k) => {
    const N = I(y);
    if (!ye(k)) {
      if (k !== void 0 && !le(k, y) && N?.operated)
        throw new Error("Either the value is returned as a new non-draft value, or only the draft is modified without returning any value.");
      const O = k?.[_r];
      if (O) {
        const q = O[0];
        return b.strict && typeof k == "object" && k !== null && gt({
          rootDraft: N,
          value: k,
          useRawReturn: !0
        }), g([q]);
      ...
      if (k !== void 0)
        return typeof k == "object" && k !== null && gt({ rootDraft: N, value: k }), g([k]);
    }
    if (k === y || k === void 0)
      return g([]);
    const C = I(k);
...
function Be(n, e) {
  return typeof n != "object" || typeof e != "object" || n === null || e === null ? n === e : xn(n, e) ? Object.keys(n).every(
    (t) => Be(n[t], e[t])
  ) : !1;
}
function Lt(n) {
...
function Rn(n, e) {
  ...
  for (const r of Object.keys(e)) {
    ...
    const s = Me(n[r]) && Me(e[r]);
    t[r] = s ? Rn(n[r], e[r]) : e[r];
  }
  return t;
}
function Me(n) {
...
function Dn(n, e) {
  ...
  if (t in n) {
    ...
    Dn(n[t], r), xr(n[t]) && delete n[t];
  }
}
function xr(n) {
  return n && Object.keys(n).length === 0;
}
const Jt = /ZULU|YEKT|YEKST|YAPT|YAKT|YAKST|XJT|WGT|WGST|WFT|WETDST|WET|WDT|WAT|WAST|WAKT|WADT|VUT|VOLT|VLAT|VLAST|VET|UZT|UZST|UYT|UYST|UTC|UT|ULAT|ULAST|UCT|TVT|TRUT|TOT|TMT|TKT|TJT|TFT|TAHT|SGT|SCT|SAST|SADT|RET|PYT|PYST|PWT|PST|PONT|PMST|PMDT|PKT|PKST|PHT|PGT|PETT|PETST|PET|PDT|OMST|OMSST|NZT|NZST|NZDT|NUT|NST|NPT|NOVT|NOVST|NFT|NDT|MYT|MVT|MUT|MUST|MST|MSK|MSD|MPT|MMT|MHT|MEZ|METDST|MET|MESZ|MEST|MDT|MAWT|MART|MAGT|MAGST|LKT|LINT|LIGT|LHST|LHDT|KST|KRAT|KRAST|KOST|KGT|KGST|KDT|JST|JAYT|IST|IRT|IRKT|IRKST|IOT|IDT|ICT|HST|HKT|GYT|GMT|GILT|GFT|GET|GEST|GAMT|GALT|FNT|FNST|FKT|FKST|FJT|FJST|FET|EST|EGT|EGST|EETDST|EET|EEST|EDT|EAT|EAST|EASST|DDUT|DAVT|CXT|CST|COT|CLT|CLST|CKT|CHUT|CHAST|CHADT|CETDST|CET|CEST|CDT|CCT|CAST|CADT|BTT|BST|BRT|BRST|BRA|BOT|BORT|BNT|BDT|BDST|AZT|AZST|AZOT|AZOST|AWST|AWSST|AST|ART|ARST|ANAT|ANAST|AMT|AMST|ALMT|ALMST|AKST|AKDT|AFT|AEST|AESST|AEDT|ADT|ACWST|ACT|ACST|ACSST|ACDT$/, Rr = {
  ZULU: 0,
  YEKT: 18e3,
  YEKST: 21600,
  YAPT: 36e3,
...
function St(n, e, t, r, s, i) {
  const o = s.slice(0, s.length - 1), a = s[s.length - 1], [c, u, l] = Ns(
    n,
    e,
    t,
    r,
...
function Jn(n, e, t, r, s) {
  return Object.entries(s).flatMap(([i, o]) => {
    if (Ks([i, o]))
      return nn(n, "or", e, t, r, o);
    if (qs([i, o]))
      return nn(n, "and", e, t, r, o);
...
function Vs(n, e, t, r) {
  const s = tt;
  return r ? Jn(s, n, e, t, r).concat(en(s, n, e, t)) : en(s, n, e, t);
}
function Qs(n, e, t) {
...
function Gs(n, e, t, { etype: r, level: s, form: i }, o) {
...
function Hs(n, e, t) {
  return t === "string" ? js(n, e) : n > e ? 1 : -1;
}
function Pe(n, e, t, r, s) {
  return e === r || e == null && r == null ? Es(n, t) : r == null ? 1 : e == null ? -1 : Hs(e, r, s);
}
...
function Yn(n, e, t) {
  ...
  if (e["forward-identity"]?.[2] === "id")
    return Ze(t, [r, o], null);
  const [a, c] = t, u = e["checked-data-type"], l = u === "date" ? Tt(c) : c, f = u === "date" ? Tt(i) : i;
  return Ze([a, l], [r, f], u);
}
function Js(n, e, t, r) {
  const s = Yn(n, e, r);
...
function ni(n, e, { etype: t, pageInfo: r, dq: s, form: i }) {
  const o = i?.$?.order, a = Zn(i), c = ri(i);
  let u = _s(n, s);
  const l = r?.["start-cursor"], f = r?.["end-cursor"], d = ei(e, t, l, o);
  ...
  u.sort(
    c === "asc" ? function(b, y) {
      return Ze(b, y, d?.["checked-data-type"]);
    } : function(b, y) {
      return Ze(y, b, d?.["checked-data-type"]);
    }
  );
  let h = {};
  const p = ti(e, t, s);
  for (const m of u) {
    const [b] = m;
    if (h[b] || !a && l && d && Js(l, d, c, m) || !a && f && d && Ys(f, d, c, m))
      continue;
    const y = cs(n, p, b);
    y && (h[b] = y);
  }
...
function si(n, e, { etype: t, level: r, form: s, join: i, pageInfo: o }) {
  if (!Zn(s) && (!o || !o["start-cursor"]))
    return [];
  const a = Fs(
    Vs(e, t, r, s.$?.where),
    i
  ), c = Qs(tt, t, r), u = s.$?.fields, l = ni(n, e, {
    etype: t,
    pageInfo: o,
    form: s,
...
function qt({
  ...
  const o = { data: Object.keys(s).reduce(function(c, u) {
    return r?.[u] || u === "$$ruleParams" || (c[u] = Xn(n, e, {
      etype: u,
      form: s[u],
      level: 0,
      pageInfo: t?.[u]
  ...
  return t && (o.pageInfo = oi(t)), r && (o.aggregate = r), o;
}
function ai() {
  const e = {
    __etype: 1,
...
function li(n) {
  return new Proxy(
    ...
    },
    {
      get(e, t) {
        if (t === "lookup")
          return (s, i) => Ge(n, vt(ui(s, i)), []);
        if (t === "__etype") return n;
        const r = t;
        return Xe(r) ? Ge(n, vt(r), []) : Ge(n, r, []);
      }
    }
  );
}
...
function yi(n, e, t) {
  if (!pi(n, e, t))
    return U(n, e, t);
  const r = At(t), s = U(n, e, r) || ge(n, e, r);
  if (s && s["value-type"] !== "ref")
    throw new Error(`${t} does not reference a valid link attribute.`);
  return s;
}
function kt(n) {
  return typeof n == "string" && !Xe(n) ? null : typeof n == "string" && Xe(n) ? vt(n) : hi(n);
}
function Y(n, e, t) {
  const r = kt(t);
  if (r === null)
    return t;
  const [s, i] = r, o = yi(n, e, s);
  if (!o || !o["unique?"])
...
function bi({ attrsStore: n }, [e, t, r]) {
...
function gi({ attrsStore: n }, [e, t, r]) {
  const s = Object.entries(r).flatMap(([i, o]) => {
    const a = Array.isArray(o) ? o : [o], c = U(n, e, i), u = ge(n, e, i);
    return a.map((l) => c ? [
      "retract-triple",
...
function nr({ stores: n, attrsStore: e }, [t, r, s, i]) {
  return i?.upsert === !1 ? { mode: "update" } : i?.upsert === !0 ? null : mi(n, e, t, r) ? { mode: "update" } : null;
}
function wi(n, e) {
  const { attrsStore: t } = n, [r, s, i, o] = e, a = Lt(i), c = Y(t, r, s);
  return [["id", c]].concat(Object.entries(a)).map(([l, f]) => {
    const d = U(t, r, l);
    return d["checked-data-type"] === "date" && n.useDateObjects && (f = et(f)), ["add-triple", c, d.id, f, { mode: "create" }];
  });
}
function _i(n, e) {
  const { attrsStore: t } = n, [r, s, i, o] = e, a = Lt(i), c = Y(t, r, s), u = nr(n, [r, c, i, o]);
...
function Yo(n, e) {
  Tn?.dispose();
  const t = ra(e), r = ea(e, a), s = Xo(Zo(n));
  function i(l) {
...
function Zo(n) {
  return `${zt || ar ? "http://localhost:3000" : "https://instantdb.com"}/_devtool?appId=${n}`;
}
function Xo(n) {
