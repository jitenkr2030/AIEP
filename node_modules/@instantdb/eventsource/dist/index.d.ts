...
export declare interface EventSourceInit {
  ...
  fetch?: FetchLike
  /**
   * Optional MessageEvent constructor to use. Defaults to `globalThis.MessageEvent`.
   * Useful for environments that do not provide a global `MessageEvent` constructor,
   * or where the global one throws.
   */
  messageEvent?: MessageEventLike
}
...
/**
 * Constructor type for creating MessageEvent instances. Used to allow passing in a custom
 * MessageEvent implementation for environments that do not provide one globally.
 *
 * @public
 */
export declare type MessageEventLike<T = any> = new (
  type: string,
  eventInitDict?: {
    data?: T
    origin?: string
