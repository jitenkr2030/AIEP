...
export class EventSource extends EventTarget {
  ...
  constructor(url: string | URL, eventSourceInitDict?: EventSourceInit) {
    ...
    this.#MessageEvent = eventSourceInitDict?.messageEvent ?? globalThis.MessageEvent
  ...
  /**
   * The MessageEvent constructor to use
   *
   * @internal
   */
  ...
  #onEvent = (event: EventSourceMessage) => {
    ...
    const messageEvent = new this.#MessageEvent(event.event || 'message', {
      data: event.data,
