...
jee:{name:"JEE Main",cat:"engineering",icon:"&#128300;",tag:"Engineering",tc:"tag-eng",desc:"Engineering entrance examination.",
    papers:{full:{title:"JEE Full",dur:180,qs:genProQ("JEE Full",50,["Mechanics","Thermodynamics","Optics","Electromagnetism","Organic Chemistry","Inorganic Chemistry","Physical Chemistry","Calculus","Algebra","Coordinate Geometry"])},math:{title:"Maths",dur:60,qs:genProQ("JEE Math",50,["Calculus","Algebra","Trigonometry","Coordinate Geometry","Vectors","Probability","Matrices","Differential Equations","Complex Numbers","Sequences"]),free:true}}},
...
ssc:{name:"SSC CGL",cat:"ssc",icon:"&#128188;",tag:"SSC",tc:"tag-gov",desc:"Staff Selection Commission.",
    papers:{gk:{title:"GK",dur:60,qs:genProQ("SSC GK",50,["Indian History","Geography","Polity","Economy","Science","Current Affairs","Static GK","Art Culture","Environment","Computer"]),free:true},quant:{title:"Quant",dur:60,qs:genProQ("SSC Quant",50,["Arithmetic","Algebra","Geometry","Trigonometry","Data Interpretation","Number System","Percentage","Ratio","Profit Loss","Time Work"])}}},
bank:{name:"Banking",cat:"banking",icon:"&#127974;",tag:"Banking",tc:"tag-eng",desc:"Bank PO/Clerk examinations.",
    papers:{po:{title:"Bank PO",dur:180,qs:genProQ("Bank PO",50,["Quantitative Aptitude","Reasoning","English","General Awareness","Computer","Banking","Current Affairs","Data Analysis","Financial Awareness","Decision Making"])},reason:{title:"Reasoning",dur:45,qs:genProQ("Bank Reasoning",50,["Seating Arrangement","Puzzles","Syllogism","Blood Relations","Coding Decoding","Inequality","Direction","Ranking","Input Output","Critical Reasoning"]),free:true}}},
clat:{name:"CLAT",cat:"law",icon:"&#9878;",tag:"Law",tc:"tag-law",desc:"Common Law Admission Test.",
    papers:{full:{title:"CLAT UG",dur:120,qs:genProQ("CLAT UG",50,["Constitutional Law","Contract Act","Criminal Law","Tort Law","Legal Reasoning","English Comprehension","Current Affairs","GK","Legal Maxims","Judgments"]),free:true}}},
nda:{name:"NDA",cat:"defence",icon:"&#9876;",tag:"Defence",tc:"tag-def",desc:"National Defence Academy.",
    papers:{math:{title:"NDA Math",dur:150,qs:genProQ("NDA Math",50,["Algebra","Trigonometry","Calculus","Matrices","Statistics","Probability","Vectors","Geometry","Mensuration","Number System"])},gat:{title:"NDA GAT",dur:150,qs:genProQ("NDA GAT",50,["English","General Knowledge","Physics","Chemistry","History","Geography","Current Affairs","Biology","Polity","Defence"]),free:true}}},
cat:{name:"CAT",cat:"management",icon:"&#128188;",tag:"MBA",tc:"tag-mgmt",desc:"MBA entrance examination.",
    papers:{full:{title:"CAT Full",dur:120,qs:genProQ("CAT Full",50,["Quantitative Aptitude","Data Interpretation","Logical Reasoning","Verbal Ability","Reading Comprehension","Arithmetic","Algebra","Geometry","Modern Math","Critical Reasoning"]),free:true}}},
ctet:{name:"CTET",cat:"teaching",icon:"&#128218;",tag:"Teach",tc:"tag-law",desc:"Teacher eligibility test.",
    papers:{p1:{title:"CTET P1",dur:150,qs:genProQ("CTET P1",50,["Child Development","Mathematics","EVS","Language I","Language II","Pedagogy","Learning","Assessment","Inclusive Education","NCERT"]),free:true},p2:{title:"CTET P2",dur:150,qs:genProQ("CTET P2",50,["Child Development","Science","Social Studies","Mathematics","Language Pedagogy","Learning Theories","Assessment","Inclusive Education","NCERT","Teaching Methods"])}}},
gate:{name:"GATE",cat:"gate",icon:"&#127891;",tag:"GATE",tc:"tag-eng",desc:"Graduate Aptitude Test in Engineering.",
    papers:{cse:{title:"GATE CSE",dur:180,qs:genProQ("GATE CSE",50,["Algorithms","Data Structures","OS","DBMS","Computer Networks","Theory of Computation","Compiler Design","Digital Logic","Discrete Maths","Programming"]),free:true},ee:{title:"GATE EE",dur:180,qs:genProQ("GATE EE",50,["Network Theory","Control Systems","Signals","Power Systems","Machines","Analog Electronics","Digital Electronics","Power Electronics","Measurements","EMFT"])},me:{title:"GATE ME",dur:180,qs:genProQ("GATE ME",50,["Thermodynamics","Fluid Mechanics","Heat Transfer","Manufacturing","Machine Design","Theory of Machines","Strength of Materials","Engineering Mechanics","Industrial Engineering","Material Science"])}}},
rbi:{name:"RBI Grade B",cat:"banking",icon:"&#127974;",tag:"RBI",tc:"tag-eng",desc:"Reserve Bank Officer examination.",
    papers:{p1:{title:"Phase I",dur:120,qs:genProQ("RBI Phase I",50,["Quantitative Aptitude","Reasoning","English","General Awareness","Banking","Finance","Current Affairs","Economic Survey","Budget","RBI Policy"]),free:true},p2:{title:"Phase II",dur:180,qs:genProQ("RBI Phase II",50,["Economic Development","Finance","Management","Monetary Policy","Banking Regulation","Financial Markets","Inflation","Forex","Public Finance","Statistics"])}}},
cuet:{name:"CUET",cat:"entrance",icon:"&#127891;",tag:"CUET",tc:"tag-eng",desc:"Common University Entrance Test.",
    papers:{gk:{title:"General Test",dur:75,qs:genProQ("CUET General",50,["General Knowledge","Current Affairs","Logical Reasoning","Quantitative Reasoning","English","General Science","History","Geography","Polity","Computer"]),free:true}}},
ntpc:{name:"RRB NTPC",cat:"ssc",icon:"&#128188;",tag:"Railway",tc:"tag-gov",desc:"Railway NTPC examination.",
    papers:{full:{title:"NTPC",dur:90,qs:genProQ("RRB NTPC",50,["General Awareness","Mathematics","Reasoning","Current Affairs","Indian Railways","Science","History","Geography","Polity","Computer"]),free:true}}},
ugcnet:{name:"UGC NET",cat:"teaching",icon:"&#128218;",tag:"UGC",tc:"tag-law",desc:"National Eligibility Test.",
    papers:{p1:{title:"Paper I",dur:120,qs:genProQ("UGC NET Paper I",50,["Teaching Aptitude","Research Aptitude","Comprehension","Communication","Math Reasoning","Logical Reasoning","Data Interpretation","ICT","People Environment","Higher Education"]),free:true}}},
