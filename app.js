...
// ---- CARDS ----
function buildCats(){var bar=document.getElementById("CATBAR");var cats=["all","monthly","professional","medical","engineering","civil","ssc","banking","law","defence","management","teaching","gate","entrance"];var labels=["All","Monthly Series","Professional","Medical","Engineering","Civil","SSC/Railway","Banking","Law","Defence","Management","Teaching","GATE","Entrance"];bar.innerHTML="";for(var i=0;i<cats.length;i++){var b=document.createElement("button");b.className="cat-btn"+(cats[i]==="all"?" on":"");b.textContent=labels[i];b.setAttribute("data-cat",cats[i]);bar.appendChild(b)}}
